...
if(filter_input(INPUT_POST, 'submit', FILTER_SANITIZE_STRING)){
  ...
  $result=$server->saveFile($_SESSION['userId'],$file);
}
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Admin | General Form Elements</title>
...
<div class="wrapper">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="file" id="exampleInputFile"  accept=".xls,.xlsx"  name="file"  max-size="1024000" value="<?= $file ?>"/>
                  <p class="help-block">Allow Upload only Excel(.xls,.xlsx) file and file size low then 1M</p>
                </div>
              </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 Voeun So All rights reserved.</strong>
  </footer>
